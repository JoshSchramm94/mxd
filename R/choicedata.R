...
#'
#' Simulated data set of two validation tasks. 50 participants were simulated,
#' each facing two different validation tasks (`id`).
...
#'   5 altrnatives plus the opt-out alternative}
