...
static constexpr std::array<const char*, 26> locations_array__ =
  ...
  " (in 'string', line 5, column 2 to column 29)",
  " (in 'string', line 6, column 8 to column 9)",
  " (in 'string', line 6, column 2 to column 36)",
...
public:
  ~model_mnl() {}
  model_mnl(stan::io::var_context& context__, unsigned int random_seed__ = 0,
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    // suppress unused var warning
    (void) DUMMY_VAR__;
    static constexpr const char* function__ = "model_mnl_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    (void) jacobian__;
    static constexpr const char* function__ =
      "model_mnl_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
      current_statement__ = 1;
...
using stan_model = model_mnl_namespace::model_mnl;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_mnl_namespace::profiles__;
}
#endif
#endif
