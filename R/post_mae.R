...
#'
#' Function to calculate posterior mean absolute error for each stored
#' posterior draw.
#'
...
#'
#' @details
#' `post_mae()` calculates the posterior mean absolute error (MAE) of a
...
#' @export
#'
post_mae <- function(betas_post, hot_data, opts, hot_choice,
